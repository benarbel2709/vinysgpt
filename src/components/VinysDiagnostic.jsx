    ...
    qs: [
      {
        ...
        opts: [
          ...
          { t: "No change", sig: {} },
          { t: "Slightly worse — amore discomfort", sig: {} },
...
const ANKLE_POSTURES = [
  {
    ...
    qs: [
      {
        id: "ankle_p1q1",
        text: "Hosn pressing your heels toward the floor, what did you feel?",
        opts: [
  ...
  },
  {
    ...
    qs: [
      {
        id: "ankle_p3q1",
        text: "Hosn your front knee moved past your toes, what did you feel in that ankle?",
        opts: [
  ...
  return (
    ...
    >
      ...
      >
        ...
        {posture.time && <div style={{ fontSize: 13, color: "rgba(255,255,255,0.6)" }}>{posture.time}</div>}
        <div
          style={{
            marginTop: 10,
            width: 52,
        ...
        <div style={{ width: "100%", maxWidth: 460 }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <div style={{ fontSize: 15, color: C.muted, lineHeight: 1.65 }}>
              Select the area you'd like to assess. We'll guide you through a short movement screen to understand your
              pattern.
            </div>
          </div>
      ...
      return (
        ...
        >
          <div style={{ width: "100%", maxWidth: 460 }}>
            ...
            <div style={{ fontSize: 22, fontWeight: 700, color: C.text, lineHeight: 1.38, marginBottom: 28 }}>
              {q.text}
            </div>
            {q.opts.map((opt, i) => (
        ...
        <div style={{ width: "100%", maxWidth: 460 }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            >
              ...
              <span style={{ fontSize: 13, fontWeight: 700, color: C.primary, letterSpacing: 0.8 }}>
                Assessment complete
              </span>
            </div>
          </div>
          ...
          {crossed && (
            ...
            >
              ...
              {AREA_CONFIG[AREA_CONFIG[origArea]?.crossoverTo || "LB"]?.label}. Your practice plan is designed
              accordingly.
            </div>
          )}
          ...
          <div
            style={{
              borderRadius: 20,
              background: prof.bg,
              border: `2px solid ${prof.color}25`,
          ...
          >
            ...
            <div style={{ fontSize: 28, fontWeight: 800, color: prof.color, lineHeight: 1.15, marginBottom: 8 }}>
              {prof.name}
            </div>
            ...
            {prof.insights.map((insight, i) => (
              <div
                ...
                style={{
                  display: "flex",
                  gap: 12,
                  marginBottom: i < prof.insights.length - 1 ? 14 : 0,
                  alignItems: "flex-start",
                }}
              >
                <div
          ...
          {/* CTAs */}
          <div style={{ marginTop: 8 }}>
            <PrimaryBtn label="Build my practice plan →" onClick={() => onComplete && onComplete(diagnosticOutput)} />
          </div>
