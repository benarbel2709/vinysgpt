// TTS endpoint — requires a valid Supabase user session.
// Used only for onboarding questionnaire voice prompts.
// Exercise videos have their own audio tracks — TTS is not needed there.
...
serve(async (req) => {
  ...
  // Require a valid logged-in user to protect ElevenLabs spend.
